...
// in weather_app_unit_test/test/mocks.dart.
...
class MockWeatherRepository extends _i1.Mock implements _i4.WeatherRepository {
  ...
  @override
  _i5.Future<_i2.WeatherEntity> getCurrentWeather(String? city) =>
      (super.noSuchMethod(
...
class MockWeatherRemoteDataSource extends _i1.Mock
  ...
  @override
  _i5.Future<_i3.WeatherModel> getCurrentWeather(String? city) =>
      (super.noSuchMethod(
            Invocation.method(#getCurrentWeather, [city]),
